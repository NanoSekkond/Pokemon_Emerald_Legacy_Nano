...
const u8 gText_ThisTMIsSoldOut[] = _("I'm sorry, but this item is sold out.{PAUSE_UNTIL_PRESS}");
const u8 gText_ThisTMIsSoldOutGameCorner[] = _("I'm sorry, but this item is sold out.");
...
const u8 gText_TM32SoldOut[] = _("TM32{CLEAR_TO 0x48}SOLD OUT");
